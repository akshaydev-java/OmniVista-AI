# 🌌 OmniVista: Multi-Modal Visual Tokenization Engine

OmniVista is a premium, unified image-video tokenizer designed for state-of-the-art visual generation. Built on top of the OmniTokenizer architecture, it provides a seamless interface for reconstructing and generating high-quality visual content.

## ✨ Key Features
- 🚀 **Unified Engine**: Single weight set for both images and videos.
- 🎨 **SOTA Performance**: Industry-leading reconstruction quality.
- ⚡ **High Adaptability**: Handles variable resolutions and long sequences.
- 🌐 **Interactive Dashboard**: Built-in Streamlit app for easy testing.
